...
type Config struct {
	...
	// ProxyPool defines named outbound proxies for bulk-assigning to auth accounts.
	// Binding an account copies the entry's ProxyURL onto the account; entries carry no
	// runtime reference from accounts.
